...
import { setUserBalance } from '../actions/ToggleMode';
import { useAppDispatch } from '../app/hooks';
import { getTokenAmount } from './useTokenInfo';
  ...
  const login = async () => {
    ...
    const providerOptions = {
      walletconnect: {
        ...
        options: {
          infuraId: "5c867c36019445949c0a2cb02e8d528e", // required
          rpc: {
            97: RPC_URL
          },
          chainId: ChainId
    ...
    const bal = await getTokenAmount(accounts[0]);
